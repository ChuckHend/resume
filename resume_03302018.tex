...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{10pt}
\namesection{Ian}{Stanton}{ \href{mailto:user@example.com}{stant099@umn.edu} | 1367 Willow St, Minneapolis, MN 55403 | (952)288-4099
}
...
\item Infrastructure
    ...
    \item Performed tests and evaluated Amazon Web Services and Microsoft Azure as host platforms for our data science environment. % a portion of...
    \end{tightemize}
    \vspace{\topsep}
% MICROSERVICES
\item Microservices
